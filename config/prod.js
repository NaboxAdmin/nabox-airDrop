...
//ChainId和资产ID
export const MAIN_INFO = { chainId: 9, assetId: 1, prefix: 'NERVE', symbol: "NVT", decimal: 8, rpc: "https://api.nerve.network/jsonrpc" };
...
export const AIR_BOX_API_URL = IS_DEV ? "/nabox-api" : "https://api.v2.nabox.io/nabox-api";
